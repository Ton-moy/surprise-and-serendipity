# This script creates user preferences for the Bayesian Linear Regression model
import os
import json
import glob
import numpy as np
from model.models import BayesianModel
from bayesian_surprise import kl_divergence

# Get the directory paths for users, topic distributions, and user preferences for the BLR model
user_dir = '../Users'
topic_distr_dir = '../topic_distrs'
user_pref_dir = '../blr_user_preferences'
...
for user_json_path in user_json_paths:
    ...
    noise_precision = 1.0
    model = BayesianModel(n_topics, default_variance, noise_precision)
    ...
    # Write out the user's info in the 'blr_user_preferences' directory
