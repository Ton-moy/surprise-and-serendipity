...
for i_one, rev_one in enumerate(user_one_reviews[start_index:]):
    ...
    if similar_user_td_sorted[0]['topic_distr_two_max'] >= max_topic_distr_diff_threshold and similar_user_td_sorted[0]['user_two_rating'] > 0:
...
print(f'****** Basic Model Serendipitous Item Recommendation *****max_topic_distr_diff_threshold_(0.12)*****top_10*****topic_distr_diff_threshold_(3.5)***{user_one_id}********************************')
