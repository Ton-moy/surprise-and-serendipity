# This script calculates the performance of vbBLR model for serendipitous item recommendation
import numpy as np
import os
import json
import glob
...
print(f'****** vbBLR Serendipitous Item Recommendation *****KL_({kl_divergence_threshold})***********mean_diff_({preference_dist_threshold})*****Top_{N}**{user_one_id}******')
