# This script calculates the performance of AROW model for serendipitous item recommendation
import numpy as np
import os
import json
import glob
...
print(f'*********AROW Serendipitous Item Recommendation*****KL_({kl_divergence_threshold})******lambda1_0.8*****lambda2_1.0*****mean_diff_(5.0)*****Top_{N}**{user_one_id}**********')
