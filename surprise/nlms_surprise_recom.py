...
for i_one, rev_one in enumerate(user_one_reviews[start_index:]):
    ...
    if similar_user_mean_diff_sorted[0]['mean_diff_two'] > mean_diff_threshold: 
...
print(f'****** NLMS Surprising Item Recommendation *****K_step_3******mean_dist_(0.56)******mean_diff_(3.5)*****Top_2**{user_one_id}******')
