# This script calculates the performance of AROW model for surprising item recommendation
import numpy as np
import os
import json
import glob
...
user_one_path = ('./arow_user_preferences/baf13c4f873e8076c5a285370bc8b681.json')
#user_one_path = ('./arow_user_preferences/c0d62a1d66649a61ffa302f8baf16d05.json')
#user_one_path = ('./arow_user_preferences/ff03096dafc8911bfe595ee1b69fa43a.json')
#user_one_path = ('./arow_user_preferences/1108a957e7eb21cc10ed1dcd5c5d1b97.json')

preference_paths = glob.glob('./arow_user_preferences/*.json')
...
preference_dist_threshold = 5.0 #tau_d
...
for i_one, rev_one in enumerate(user_one_reviews[start_index:]):
    ...
    if similar_user_kl_sorted[0]['kl_div_two'] > kl_divergence_threshold: 
...
print(f'****** AROW Surprising Item Recommendation *****KL_({kl_divergence_threshold})******lambda1_0.8*****lambda2_1.0*****mean_diff_(5.0)*****Top_{N}**{user_one_id}*****')
