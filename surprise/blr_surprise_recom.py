# This script calculates the performance of BLR model for surprising item recommendation
import numpy as np
import os
import json
import glob
...
print(f'****** BLR Surprising Item Recommendation *****KL_({kl_divergence_threshold})***********mean_diff_({preference_dist_threshold})*****Top_{N}**{user_one_id}******')
